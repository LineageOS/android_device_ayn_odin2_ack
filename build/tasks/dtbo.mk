...
$(TARGET_OUT_PRODUCT_ETC)/firmware/${1}_dtbo.img: $(PRODUCT_OUT)/kernel $(MKDTBOIMG) $(AVBTOOL) $(productimage_intermediates)/file_list.txt
	$(MKDTBOIMG) create $(TARGET_OUT_PRODUCT_ETC)/firmware/${1}_dtbo.img --page_size=$(BOARD_KERNEL_PAGESIZE) $(abspath $(KERNEL_OUT))/qcs8550-ayntec-${1}.dtbo
	...
	$(hide) grep etc/firmware/${1}_dtbo.img $(productimage_intermediates)/file_list.txt > /dev/null 2>&1 || echo firmware/${1}_dtbo.img >> $(productimage_intermediates)/file_list.txt
...
$(eval $(call postinstall_dtbo_rule,odin2))
$(eval $(call postinstall_dtbo_rule,odin2mini))
$(eval $(call postinstall_dtbo_rule,odin2portal))
$(eval $(call postinstall_dtbo_rule,thor))
endif
